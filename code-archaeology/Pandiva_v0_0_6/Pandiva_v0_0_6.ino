...
int acordes1[] = {48,50,52,53,55,57,59};
int acordes2[] = {52,53,55,57,59,60,62};
int acordes3[] = {55,57,59,60,62,64,65};
...
int calculateToSend(int index, int vara){
  ...
  if(mode == MELODIC){
    ...
    int indiceAcordes = map(vara, 0, 1023, 0, 6);
    indiceAcordes = int(indiceAcordes);
    indiceAcordes = constrain(indiceAcordes, 0, 6);
